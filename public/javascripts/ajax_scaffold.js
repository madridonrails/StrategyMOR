  ...
  stripe: function(tableBody) {
    ...
    for (var i = 0; i < length; i++) {
      ...
      if (!Element.hasClassName(tableRow, "create") 
        ...
        && !Element.hasClassName(tableRow, "paginador")) {
      	
        if (even) {
          Element.removeClassName(tableRow, "filaimpar");
          Element.addClassName(tableRow, "filapar");
        } else {
          Element.removeClassName(tableRow, "filapar");
          Element.addClassName(tableRow, "filaimpar");
        }
        even = !even;
      }
    }
